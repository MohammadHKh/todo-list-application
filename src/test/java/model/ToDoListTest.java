...
class ToDoListTest {
    ...
    void readFromFileAsObject() {
        ...
        expectedArrayList.add(new Task("Test0", "Test2", new Date(2020 - 10 - 10)));
        expectedArrayList.add(new Task("Test1", "Test2", new Date(2020 - 10 - 10)));
        expectedArrayList.add(new Task("Test2", "Test2", new Date(2020 - 10 - 10)));

        UserCommand toDoList = new ToDoList();
        toDoList.taskList.add(new Task("Test0", "Test2",  new Date(2020 - 10 - 10)));
        toDoList.taskList.add(new Task("Test1", "Test2",  new Date(2020 - 10 - 10)));
        toDoList.taskList.add(new Task("Test2", "Test2",  new Date(2020 - 10 - 10)));
